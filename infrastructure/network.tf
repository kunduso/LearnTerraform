module "vpc" {
  ...
  vpc_cidr                = "11.22.32.0/24"
  subnet_cidr_public      = ["11.22.32.0/27", "11.22.32.32/27", "11.22.32.64/27"]
  subnet_cidr_private     = ["11.22.32.128/27", "11.22.32.160/27", "11.22.32.192/27"]
